...
export const login = async (req, res) => {
  try {
    const { code, isSilent } = req.body;

    console.log("====================================");
    console.log("login", code, "isSilent:", isSilent);
    console.log("====================================");
    ...
    if (existingUsers.length === 0) {
      ...
      if (isSilent) {
        // 静默登录时使用默认值
        nickname = 'MTT4827';
        avatar = 'https://evan-1304983303.cos.ap-nanjing.myqcloud.com/global/mini-shop/mt.jpg';  // 确保有一个默认头像
      } else {
        // 非静默登录，获取微信用户信息
        ...
        avatar = userInfoResult.data.headimgurl;
      }
...
export const testLogin = async (req, res) => {
  try {
    ...
    const mockWechatData = {
      ...
      nickname: "测试用户",
      headimgurl: "https://evan-1304983303.cos.ap-nanjing.myqcloud.com/global/mini-shop/mt.jpg", // 使用随机猫咪图片作为测试头像
    };
